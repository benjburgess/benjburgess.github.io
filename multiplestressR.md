...
The *multiplestressR* package is currently available from [my github account](github.com/benjburgess/multiplestressR) and can be installed in R with two lines of code.
